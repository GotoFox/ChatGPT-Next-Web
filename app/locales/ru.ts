...
const ru: LocaleType = {
  ...
  authModel: {
    ...
    logInNow: "Вход в аккаунт",
    cancel: "отменить",
    userName: "имя пользователя",
    password: "пароль",
    email: "почта",
    invitationCode: "пригласительный код",
    noUser: "Нет аккаунта? Зарегистрируйтесь сейчас >>",
    yesUser: "Уже есть аккаунт? Вход в аккаунт >>",
    rememberPsd: "Запомнить пароль",
    getAnInvitationCode: "Получить приглашение",
    Toast: {
      upCannotBeEmpty: "Имя пользователя и пароль не могут быть пустыми",
      uepCannotBeEmpty:
        "Имя пользователя, электронная почта и пароль не могут быть пустыми",
      invitationCodeCannotBeEmpty: "Пригласительный код не может быть пустым",
      usernameRestrictions:
        "Имя пользователя может содержать только буквы и цифры, и его длина не может превышать 30 символов",
      emailVerification: "Введите правильный адрес электронной почты",
      pleaseEnterUe: "Введите имя пользователя / электронную почту",
      pleaseEnterPwd: "Введите пароль",
      pleaseEnterUser: "Введите имя пользователя",
      pleaseEnterEmail: "Введите свой адрес электронной почты",
      pleaseEnterInvitationCode: "Введите пригласительный код",
      getAnInvitationCode:
        "На данный момент механизм приглашений уже запущен, но в связи со множеством неизвестных факторов внутренних тестов общедоступный код приглашения временно не размещается. Вы можете использовать пригласительный код, сгенерированный другим зарегистрированным пользователем.",
      error: "Ошибка сетевого запроса, повторите попытку позже",
    },
  },
};
